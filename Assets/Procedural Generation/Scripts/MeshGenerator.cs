...
namespace ProceduralMeshGeneration {
            ...
            for (int y = 0; y < numVertsPerLine; y++) {
                for (int x = 0; x < numVertsPerLine; x++) {
                    ...
                    bool isEdgeConnectionVertex =
                        (y == 2 || y == numVertsPerLine - 3 || x == 2 || x == numVertsPerLine - 3) && !isMainVertex &&
                        !isOutOfMeshVertex && !isMeshEdgeVertex; 
                    ...
                    if (isEdgeConnectionVertex) {
                        ...
                        height = Mathf.Lerp(heightMainVertexA, heightMainVertexB, dstPercentFromAToB);
                    }
    ...
    public class MeshData{
        ...
        public MeshData(int numVertsPerLine, int skipIncrement, bool useFlatShading){
            ...
            vertices = new Vector3[numEdgeConnectionVertices + numMeshEdgeVertices + numMainVertices];
